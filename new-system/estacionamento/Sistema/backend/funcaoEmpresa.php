...
function listaUsuario(){
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        foreach ($result as $coluna) {
            ...
            '<tr>'
                ...
                .'<td>'
                    .'<div class="row" align="center">'
                        .'<div class="col-6">'
                            .'<a href="#modalEditUsuario'.$coluna["id_empresa"].'" data-toggle="modal">'
                                .'<h6><i class="fas fa-edit text-info" data-toggle="tooltip" title="Alterar usuário"></i></h6>'
                            .'</a>'
                        .'</div>'
                        
                        .'<div class="col-6">'
                            .'<a href="#modalDeleteUsuario'.$coluna["id_empresa"].'" data-toggle="modal">'
            ...
            .'<div class="modal fade" id="modalEditUsuario'.$coluna["id_empresa"].'">'
                .'<div class="modal-dialog modal-lg">'
                    .'<div class="modal-content">'
                        ...
                        .'<div class="modal-body">'
                            ...
                            .'<form method="POST" action="backend/salvarUsuario.php?funcao=A&codigo='.$coluna["id_empresa"].'" enctype="multipart/form-data">'              
            ...
            .'<div class="modal fade" id="modalDeleteUsuario'.$coluna["id_empresa"].'">'
                .'<div class="modal-dialog">'
                    .'<div class="modal-content">'
                        .'<div class="modal-header bg-danger">'
                            .'<h4 class="modal-title">Excluir Usuário: '.$coluna["id_empresa"].'</h4>'
                            .'<button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">'
                                .'<span aria-hidden="true">&times;</span>'
                            .'</button>'
                        .'</div>'
                        .'<div class="modal-body">'
                            ...
                            .'<form method="POST" action="backend/salvarUsuario.php?funcao=D&codigo='.$coluna["id_empresa"].'" enctype="multipart/form-data">'              
...
function proxIdUsuario(){
    ...
    include("conexao.php");
    $sql = "SELECT MAX(id_empresa) AS Maior FROM usuario;";        
    $result = mysqli_query($conn,$sql);
    mysqli_close($conn);
...
function tipoAcessoUsuario($id){
    ...
    include("conexao.php");
    $sql = "SELECT fk_id_tipo_usuario FROM usuario WHERE id_empresa = $id;";        
    $result = mysqli_query($conn,$sql);
    mysqli_close($conn);
...
function fotoUsuario($id){
    ...
    include("conexao.php");
    $sql = "SELECT foto FROM usuario WHERE id_empresa = $id;";        
    $result = mysqli_query($conn,$sql);
    mysqli_close($conn);
...
function nomeUsuario($id){
    ...
    include("conexao.php");
    $sql = "SELECT nome FROM usuario WHERE id_empresa = $id;";        
    $result = mysqli_query($conn,$sql);
    mysqli_close($conn);
...
function loginUsuario($id){
    ...
    include("conexao.php");
    $sql = "SELECT email FROM usuario WHERE id_empresa = $id;";        
    $result = mysqli_query($conn,$sql);
    mysqli_close($conn);
...
function ativoUsuario($id){
    ...
    include("conexao.php");
    $sql = "SELECT flg_ativo FROM usuario WHERE id_empresa = $id;";        
    $result = mysqli_query($conn,$sql);
    mysqli_close($conn);
