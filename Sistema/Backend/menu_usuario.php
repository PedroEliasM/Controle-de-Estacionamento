              ...
              <div class="card-header">
                ...
                <form method="POST" action="php/salvaPerfil.php" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-3 text-center">
                                                    <div class="foto-perfil mx-auto">
                                                        <img alt=" NomeLogin " src="imagens/logo.png" class="foto">
                                                        <div class="trocar-imagem">
                                                            <i class="fas fa-camera upload-button"></i>
                                                            <p>Alterar Foto</p>
                                                            <input class="arquivo" name="Foto" type="file" title="" accept="imagens/*"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-9">
                        ...
                        <div class="card-action" align="right">
                            <a href="index.php" class="btn btn-danger" data-toggle="tooltip" title="Limpar as Alterações">
                                <span>Limpar</span>
                            </a>
                            <input type="submit" class="btn btn-success" value="Salvar" data-toggle="tooltip" title="Salvar as Alterações">
                        </div>
                        </div>
                </form>
                </div>
